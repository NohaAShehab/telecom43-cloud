...
urlpatterns = [
    ...
    path('hellowolddjango', helloworld, name='iti'),
    path('home', homepage, name='homepagename'),
    path('home/<username>', homeuser, name='homeuser'),
    path('datatypes',returndatatypes,name='datatypes' ),
